      ...
      >
        <Navbar.Brand className="ml-4 text-secondary" href="/">
          <h3>
            Chillar
            <i
              className="fa fa-registered pr-3 text-secondary align-top pt-2 pl-1"
              style={{ fontSize: "10px" }}
            />
          </h3>
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="ml-auto d-flex justify-content-end mr-2 align-items-center">
            ...
            <Dropdown alignRight className="ml-1 pt-1">
              ...
              <Dropdown.Menu>
                <Dropdown.Header>Pk</Dropdown.Header>
                {/* Username */}
                ...
                <Dropdown.Divider />
                <Dropdown.Item eventKey="4" variant="white">
                  Logout
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
