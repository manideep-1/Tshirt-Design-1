    ...
    const [faqs, setfaqs] = useState([
        {
          ...
          description : 'If the amount has been deducted from your bank or card, don\'t worry; it will be refunded to the same account within 7-10 business days.',
          a:"Meanwhile, please wait a while and try again, preferably using a different payment method.",
        ...
        {
          question: "My transaction failed but an amount was deducted from my Chillar wallet. What do I do?",
        ...
        {
          question: 'I have Loyalty money in my Chillar Wallet. Can I transfer it to my bank account?',
          description:"No. The Loyalty Money is associated with your Bewakoof account only, and cannot be en-cashed or transferred to other accounts.",
          open: false
        },
        {
            question:"Can I pay using an international card?",
            description:"We currently do not accept payment via international cards.",
            open:false
        },
        {
          question:"I have self-shipped. How do I get the refund?",
          description:"If you have self-shipped the product already, please email us the screenshot of the courier receipt along with the order id number. ",
          a:"Our customer care executive will work on your query. We will get back to you in the next 24 hours.",
          open:false
        },
        {
          question:"Will Chillar.com Employee ask for my Confidential Information?",
